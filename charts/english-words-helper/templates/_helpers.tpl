...
{{- define "service-template.configSha256" -}}
{{ .Values.settings | toYaml | sha256sum | trunc 8 }}
{{- end }}

{{- define "service-template.configMapName" -}}
{{- printf "%s-%s" (include "service-template.fullname" . ) (include "service-template.configSha256" .) }}
{{- end }}
